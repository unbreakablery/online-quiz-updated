                ...
                <div class="block-content block-content-narrow">
                    <form class="form-horizontal" name="que-form" id="que-form" action="" method="post" autocomplete="off">
                            ...
                            <div class="col-md-7">
                                <select class="form-control" name="quiz-id" id="quiz-id" require>
                                    <?php foreach ($quizzes as $quiz) { ?>
                                        <option value="<?php echo $quiz['id']?>" <?php if ($quiz['id'] == $quiz_id) { ?>selected<?php } ?>>
                                            <?php echo $quiz['quiz_code']; ?> (<?php echo $quiz['quiz_type']; ?>) - <?php echo getPageName($quiz['page']); ?>
                                        </option>
                                    <?php } ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input class="form-control" type="text" id="video" name="video" value="<?php echo $video; ?>" placeholder="Enter Video File Name .." />
                            </div>
                        </div>
                        <div class="form-group">
