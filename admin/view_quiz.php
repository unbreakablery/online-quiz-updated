            ...
            <div class="block">
                ...
                <div class="block-content block-content-narrow">
                    <form class="form-horizontal" name="quiz-form" id="quiz-form" action="save_quiz.php" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="page">Page<span class="text-danger">*</span></label>
                            <div class="col-md-7">
                                <select class="form-control" name="page" id="page" require>
                                    <option value="main" <?php if ($page == 'main') { ?>selected<?php } ?>><?php echo getPageName('main'); ?></option>
                                    <option value="ratings" <?php if ($page == 'ratings') { ?>selected<?php } ?>><?php echo getPageName('ratings'); ?></option>
                                    <option value="s-f-sjt" <?php if ($page == 's-f-sjt') { ?>selected<?php } ?>><?php echo getPageName('s-f-sjt'); ?></option>
                                    <option value="s-msra" <?php if ($page == 's-msra') { ?>selected<?php } ?>><?php echo getPageName('s-msra'); ?></option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
