    ...
    <div class="col-lg-6 col-md-6">
        <div class="block block-themed" id="quiz-block">
            ...
            <div class="block-content block-content-narrow" id="quiz-block-content">
                <div id="video-section" class="col-lg-12 col-md-12 col-sm-12">
                    <?php if (!empty($cur_que['video'])) { ?>
                    <video controls autoplay playsinline style="width: 100%; height: auto;">
                        <source src="<?php echo $one->assets_folder . '/uploads/' . $cur_que['video']; ?>" type="video/mp4">
                        <source src="<?php echo $one->assets_folder . '/uploads/' . $cur_que['video']; ?>" type="video/ogg">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var t_cnt = <?php echo strlen($cur_que['cor_ans']); ?>;
